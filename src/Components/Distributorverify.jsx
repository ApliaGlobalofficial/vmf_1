...
const VerifyDocuments = () => {
  ...
  const fetchCertificatesAndDocuments = async (userId) => {
    try {
      const [certRes, docRes] = await Promise.all([
        axios.get("http://3.6.61.72:3000/certificates", authHeaders),
        axios.get(`http://3.6.61.72:3000/documents/list/${userId}`, authHeaders),
      ]);
  ...
  const fetchCertificates = async () => {
    try {
      const response = await axios.get(
        "http://3.6.61.72:3000/certificates", authHeaders
      );
  ...
  const fetchDocuments = async (distributorId) => {
    try {
      const response = await axios.get(
        `http://3.6.61.72:3000/documents/list/${distributorId}`, authHeaders
      );
  ...
  const handleUploadCertificate = async (documentId) => {
    ...
    try {
      await axios.post(
        "http://3.6.61.72:3000/certificates/upload", 
        formData,
        {
